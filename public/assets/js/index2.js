document.addEventListener("DOMContentLoaded", function () {
    // Replace 'myChart' with the actual id of your canvas
    var canvas = document.getElementById("myChart");

    if (canvas) {
        var ctx = canvas.getContext("2d");

        // Your existing chart code here, e.g.:
    } else {
        // Canvas not found, do nothing or log if you want
...
$(function () {
    ...
    $("#chart4").sparkline(
        [
            5, 8, 7, 10, 9, 10, 8, 6, 4, 6, 8, 7, 6, 8, 9, 10, 8, 6, 4, 5, 8, 7,
            10, 9, 5, 8, 7, 9, 5, 4, 8, 7, 10, 9, 5, 8, 7, 9, 5, 4,
        ],
        {
            type: "bar",
            height: "25",
