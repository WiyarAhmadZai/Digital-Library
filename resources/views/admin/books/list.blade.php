    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#booksTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('books.data') }}', // Make sure this URL is correct and returns JSON
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
                ...
                drawCallback: function(settings) {
                    ...
                    $('.swiper-container').each(function() {
                        var swiperInstance = new Swiper(this, {
                            ...
                            loop: true,
                            simulateTouch: true,
                            // no autoplay, no navigation
                        });

                        $(this).on('click', '.swiper-slide img', function() {
            ...
            // Delete button handler if you have one
