                                    ...
                                    <div class="book-thumb center">
                                        ...
                                        <ul class="shop-icon d-grid justify-content-center align-items-center">
                                            ...
                                            <li><a href="#"><img class="icon"
                                                        src="{{ asset('assets/img/icon/shuffle.svg') }}"
                                                        alt="shuffle"></a>
                                            </li>
                    ...
                    @foreach ($bestSellers as $index => $book)
                        ...
                        <div class="shop-box-items style-3 wow fadeInUp" data-wow-delay="{{ $delay }}s">
                            ...
                            <div class="shop-content">
                                ...
                                <h3><a href="{{ route('frontend.shopDetailsData', $book->id) }}">{{ $book->name }}</a>
                                </h3>
            ...
            <div class="container">
                <div class="cta-banner-wrapper style-2 section-padding bg-cover"
                    ...
                    <div class="cta-content text-left">
                        <h2 class="text-white mb-40 wow fadeInUp" data-wow-delay=".3s">Get 25% discount in all <br> kind
                            of
                            super Selling</h2>
                            ...
                            <div class="shop-box-items style-2">
                                ...
                                <div class="shop-content">
                                    ...
                                    <ul class="author-post">
                                        <li class="authot-list">
                                            <span class="thumb">
                                                <img src="{{ asset('assets/img/testimonial/client-1.png') }}"
                                                    alt="img">
                                            </span>
                            ...
                            <div class="shop-box-items style-2">
                                ...
                                <div class="shop-content">
                                    ...
                                    <ul class="author-post">
                                        <li class="authot-list">
                                            <span class="thumb">
                                                <img src="{{ asset('assets/img/testimonial/client-2.png') }}"
                                                    alt="img">
                                            </span>
                            ...
                            <div class="shop-box-items style-2">
                                ...
                                <div class="shop-content">
                                    ...
                                    <ul class="author-post">
                                        <li class="authot-list">
                                            <span class="thumb">
                                                <img src="{{ asset('assets/img/testimonial/client-3.png') }}"
                                                    alt="img">
                                            </span>
                            ...
                            <div class="shop-box-items style-2">
                                ...
                                <div class="shop-content">
                                    ...
                                    <ul class="author-post">
                                        <li class="authot-list">
                                            <span class="thumb">
                                                <img src="{{ asset('assets/img/testimonial/client-4.png') }}"
                                                    alt="img">
                                            </span>
                            ...
                            <div class="shop-box-items style-2">
                                ...
                                <div class="shop-content">
                                    ...
                                    <ul class="author-post">
                                        <li class="authot-list">
                                            <span class="thumb">
                                                <img src="{{ asset('assets/img/testimonial/client-5.png') }}"
                                                    alt="img">
                                            </span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                        <div class="news-card-items">
                            ...
                            <div class="news-content">
                                ...
                                <h3><a href="news-details.html">Playful Picks Paradise: Kids’ Essentials with Dash.</a>
                                </h3>
                                <a href="news-details.html" class="theme-btn-2">Read More <i
                                        class="fa-regular fa-arrow-right-long"></i></a>
                            </div>
