                    ...
                    <div class="col-lg-7">
                        <div class="shop-details-content">
                                ...
                                <div class="modal fade" id="readMoreModal" tabindex="-1" aria-labelledby="readMoreModalLabel" aria-hidden="true">
                                    <div class="modal-dialog"> 
                                        <div class="modal-content">
                                            <div class="modal-body" style="background-image: url({{asset('assets/img/popupBg.png')}});"> 
                                                <div class="close-btn">
                            ...
                            <div class="social-icon">
                                ...
                                <a href="https://www.customer.io/"><img src="{{asset('assets/img/cutomerio.png')}}" alt="cutomer.io"></a>
                                <a href="https://www.amazon.com/"><img src="{{asset('assets/img/amazon.png')}}" alt="amazon"></a>
                                <a href="https://www.dropbox.com/"><img src="{{asset('assets/img/dropbox.png')}}" alt="dropbox"></a>
                            </div>
                        </div>
                    </div>
                </div>
