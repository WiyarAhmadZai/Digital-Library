<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li> <a href="{{ route('admin.dashboard') }}"><i class='bx bx-home-alt'></i>Dashboard</a></li>
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href="app-contact-list.html"><i class='bx bx-radio-circle'></i>Contacts</a></li>
                        ...
                        <li>
                            <a href="javascript:;" class="has-arrow">
                                ...
                                <div class="menu-title">
                                    <span
                                        style="color: black; margin-right: 5px; font-size: 12px; background-color: goldenrod; font-weight: bold; padding: 2px 4px; border-radius: 5px;">
                                        New
                                    </span> Book
                                </div>
                            </a>
                            <ul>
                                <li><a href="{{ route('admin.book.create') }}"><i class='bx bx-radio-circle'></i>create</a>
                                </li>
                                <li><a href="{{ route('admin.book.list') }}"><i class='bx bx-radio-circle'></i>Book List</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul>
                                <li><a href="{{ route('admin.author.create') }}"><i
                                            class='bx bx-radio-circle'></i>create</a></li>
                                <li><a href="{{ route('admin.author.index') }}"><i class='bx bx-radio-circle'></i>Authors
                                        List</a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul>
                                <li><a href="{{ route('admin.post.create') }}"><i class='bx bx-radio-circle'></i>create</a>
                                </li>
                                <li><a href="{{ route('admin.posts.index') }}"><i class='bx bx-radio-circle'></i>View
                                        Post</a>
                                </li>
                            </ul>
                        </li>
